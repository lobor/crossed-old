...
var RadioIndicator_exports = {};
__export(RadioIndicator_exports, {
  RadioIndicator: () => RadioIndicator
});
module.exports = __toCommonJS(RadioIndicator_exports);
var import_react = __toESM(require("react"));
var import_RadioProvider = require("./RadioProvider");
const RadioIndicator = (StyledRadioIndicator) => (0, import_react.forwardRef)(({ children, ...props }, ref) => {
  const {
    isChecked,
    isDisabled,
    isFocusVisible,

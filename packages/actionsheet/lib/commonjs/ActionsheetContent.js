...
function ActionsheetContent(StyledActionsheetContent, AnimatePresence) {
  return /*#__PURE__*/(0, _react.forwardRef)((_ref, ref) => {
    ...
    const contentSheetAnimatePosition = _react.default.useMemo(() => windowHeight - snapPoints[0] * windowHeight * 0.01, [snapPoints]);
    ...
    }, dialogProps), /*#__PURE__*/_react.default.createElement(_ActionsheetContentContext.ActionsheetContentProvider, {

...
function Tooltip(StyledTooltip) {
  return forwardRef(
    ({
      ...
      return /* @__PURE__ */ React.createElement(React.Fragment, null, updatedTrigger(targetRef), /* @__PURE__ */ React.createElement(Overlay, { isOpen, onRequestClose: handleClose, unmountOnExit: true }, /* @__PURE__ */ React.createElement(
        TooltipProvider,
        {
          value: {
            placement,
